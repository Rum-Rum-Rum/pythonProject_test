...
def info(link):
    ...
    input2 = browser.find_element(By.CSS_SELECTOR, '.form-group.second_class input.form-control.second')
    input2.send_keys("+79216502452")
    input2 = browser.find_element(By.CSS_SELECTOR, '.form-group.third_class input.form-control.third')
...
class TestLesson(unittest.TestCase):
    ...
    def test_les_2(self):
        welcome_text = info(link_1)
        self.assertEqual("Congratulations! You have successfully registered!", welcome_text, "Ahtung ! Not work")


    def test_les_3(self):
        welcome_text = info(link_2)
        self.assertEqual("Congratulations! You have successfully registered!", welcome_text, "Ahtung ! Not work")
